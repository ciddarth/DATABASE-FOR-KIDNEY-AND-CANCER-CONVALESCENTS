...
#customers tr:nth-child(even){background-color: #00FA9A;}
...
tr:nth-child(even) {background-color: #CD853F}
</style>
</head>
...
<?php
$conn = mysqli_connect("localhost", "root" ,"", "hello1");
if ($conn-> connect_error){
	die("Connection failed:". $conn-> connect_error);
}
$sql= "SELECT*FROM once";
